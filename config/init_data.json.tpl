  ...
  "applications": [
    {
      ...
      "clientSecret": "${AUTH_CASDOOR_SECRET}",
      "redirectUris": [
      ...
      "origin": "https://esade-user81-casdoor.duckdns.org"
    },
    {
      "owner": "admin",
      "name": "app-built-in",
  ...
  "ldaps": [
    {
      ...
      "password": "${CASDOOR_LDAP_BIND_PASSWORD}",
  ...
  "users": [
    {
      ...
      "externalId": "",
      "type": "normal-user",
      "password": "${CASDOOR_DEFAULT_USER_PASSWORD}",
      "passwordSalt": "",
      "passwordType": "plain",
      "displayName": "User",
      "firstName": "",
    ...
    },
    {
      ...
      "externalId": "",
      "type": "normal-user",
      "password": "${CASDOOR_DEFAULT_ADMIN_PASSWORD}",
      "passwordSalt": "",
      "passwordType": "plain",
      "displayName": "Admin",
      "firstName": "",
  ...
  "webhooks": [
    {
      ...
      "organization": "lobechat",
      "url": "http://lobe-chat:3210/api/webhooks/casdoor",
      "method": "POST",
