{
  "mcpServers": {
    ...
    "aws-resources-operations": {
      ...
      "args": [
        "--from",
        "git+https://github.com/baryhuang/mcp-server-aws-resources-python.git",
        "python",
        "-m",
        "mcp_server_aws_resources.server",
        "--region",
        "${AWS_REGION}"
      ],
      "env": {
    ...
    "pickstar-2002-minio-mcp": {
      ...
      "args": [
        ...
        "--access-key={{config.MINIO_ACCESS_KEY}}",
        "--secret-key={{config.MINIO_SECRET_KEY}}",
        "--use-ssl={{config.MINIO_USE_SSL}}",
  ...
  "systemConfig": {
    ...
    "routing": {
      ...
      "bearerAuthKey": "${MCPHUB_BEARER_KEY}",
      "skipAuth": false
    },
    "install": {
      "pythonIndexUrl": "",
  ...
  "users": [
    {
      "username": "admin",
      "password": "${MCPHUB_ADMIN_PASSWORD_HASH}",
      "isAdmin": true
    }
  ],
  "bearerKeys": [
    {
      "id": "26956cff-8c43-4979-aacd-4251a1ab3c0e",
      "name": "lobechat",
      "token": "${MCPHUB_BEARER_KEY}",
      "enabled": true,
      "accessType": "all",
      "allowedGroups": [],
      "allowedServers": []
